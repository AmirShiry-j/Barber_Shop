...
namespace Persistence.Migrations
{
    ...
    [Migration("20230119143814_For_Address")]
    partial class For_Address
    {
            ...
            modelBuilder.Entity("Domain.Addresses.Address", b =>
                {
                    b.HasOne("Domain.Addresses.City", "City")
                        .WithOne()
                        .HasForeignKey("Domain.Addresses.Address", "CityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Salons.Salon", null)
                        .WithOne("Address")
                        .HasForeignKey("Domain.Addresses.Address", "SalonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
